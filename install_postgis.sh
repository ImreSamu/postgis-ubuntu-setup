...
sudo  apt-get install -y postgresql-server-dev-9.3 libjson0-dev libxml2-dev libproj-devs
sudo  apt-get install -y python2.7-dev swig binutils
...
sudo gdebi gdal_$GDALVERSION-1_amd64.deb
}
